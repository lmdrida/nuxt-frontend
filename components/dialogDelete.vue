      ...
      >
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            <h2 class="text-2xl font-medium text-center mb-6">Delete Activity</h2>
            <div class="mb-4">Are you sure Delete Activity</div>
          </div>
        </div>
...
const confirmDialog = async () => {
  //   const res = await deleteActivity(props.data.id);
  console.log("is", props.data.id);
};
</script>
